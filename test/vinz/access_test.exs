defmodule Vinz.Access.Test do
  ...
  setup_all do
    ...
    principal = Principal.new(name: "test-access") |> Repo.create
    group = Group.new(name: "access-test", comment: "a group for testing access controll") |> Repo.create
    GroupMember.new(vinz_access_group_id: group.id, vinz_access_principal_id: principal.id) |> Repo.create
    ...
    Right.new(name: "test-access-read-rilter-a", resource: resource, global: false, domain: "a", vinz_access_group_id: group.id, can_read: true) |> Repo.create
    Right.new(name: "test-access-read-rilter-b", resource: resource, global: false, domain: "b", vinz_access_group_id: group.id, can_read: true) |> Repo.create
